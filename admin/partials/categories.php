...
<div class="amaps-p-cont">
  ...
  <div class="row">
    <div class="col-md-12 ralign">
      ...
      <button type="button" id="btn-amaps-new-c" class="btn btn-primary mrg-r-10">New Category</button>
    </div>
  </div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form name="frm-updatecategory" id="frm-updatecategory">              
                ...
                <button class="btn btn-primary btn-start mrg-r-15" id="btn-amaps-update-categories"   type="button" data-loading-text="Submitting ...">Update Category</button>
...
<div class="modal fade amaps-p-cont" id="amaps-new-cat-box" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
               <form name="frm-upload-logo" id="frm-addcategory">
                  ...
                  <div class="modal-footer">
                      <button class="btn btn-primary btn-start mrg-r-15" id="btn-amaps-add-categories" type="button" data-loading-text="Submitting ...">Add Category</button>
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                  </div>
              </form>
          </div>
...
amaps_engine.pages.manage_categories();
</script>
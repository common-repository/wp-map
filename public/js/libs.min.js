...
/*Loading methods*/
var tab_loading = {show: function(){jQuery('.amaps-p-cont > .loading').removeClass('hide');},hide: function(){jQuery('.amaps-p-cont > .loading').addClass('hide');}};
